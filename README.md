...
Созданный компонент умеет:
 ...
 - **Принцип единой ответственности**
    ...
    Что если нужно реализовать возможность подписаться на email рассылку (форма из нескольких вложенных компонентов через цепочку state-props), но только для тех пользователей, у которых указано отчество? Создавать контекст потенциально не безопасно, так как не гарантирует отсутствие новых правок.
